...
object Function {
  ...
  /**
    ...
    */
  def map2[T1, T2, R](t1y: Try[T1], t2y: Try[T2])(f: (T1, T2) => R): Try[R] = for(a <- t1y; b <- t2y) yield f(a, b)
  ...
  def map3[T1, T2, T3, R](t1y: Try[T1], t2y: Try[T2], t3y: Try[T3])(f: (T1, T2, T3) => R): Try[R] =
    for(a <- t1y; b <- t2y; c <- t3y) yield f(a, b, c)
  ...
  def lift2[T1, T2, R](f: (T1, T2) => R): (Try[T1], Try[T2]) => Try[R] =  (a: Try[T1], b: Try[T2]) => Try(f(a.get, b.get))
  ...
  def lift3[T1, T2, T3, R](f: (T1, T2, T3) => R): (Try[T1], Try[T2], Try[T3]) => Try[R] = (a: Try[T1], b: Try[T2], c: Try[T3]) => Try(f(a.get, b.get, c.get))
  ...
  (Try[T1], Try[T2], Try[T3], Try[T4], Try[T5], Try[T6], Try[T7]) => Try[R] = (a: Try[T1], b: Try[T2], c: Try[T3], d: Try[T4], e: Try[T5], g: Try[T6], h: Try[T7]) => Try(f(a.get, b.get, c.get, d.get, e.get, g.get, h.get))
  ...
  def invert2[T1, T2, R](f: T1 => T2 => R): T2 => T1 => R = (a:T2) => (b: T1) => f(b)(a)
  ...
  def invert4[T1, T2, T3, T4, R](f: T1 => T2 => T3 => T4 => R): T4 => T3 => T2 => T1 => R = (a:T4) => (b: T3) => (c: T2) => (d: T1) => f(d)(c)(b)(a)
  ...
  def uncurried2[T1, T2, T3, R](f: T1 => T2 => T3 => R): (T1, T2) => T3 => R = (a: T1, b: T2) => (c: T3) => f(a)(b)(c)
  ...
  def uncurried3[T1, T2, T3, T4, R](f: T1 => T2 => T3 => T4 => R): (T1, T2, T3) => T4 => R = (a: T1, b: T2, c: T3) => (d: T4) => f(a)(b)(c)(d)
  ...
  def uncurried7[T1, T2, T3, T4, T5, T6, T7, T8, R](f: T1 => T2 => T3 => T4 => T5 => T6 => T7 => T8 => R): (T1, T2, T3, T4, T5, T6, T7) => T8 => R =
    (a: T1, b: T2, c: T3, d: T4, e: T5, g: T6, h: T7) => (i: T8) => f(a)(b)(c)(d)(e)(g)(h)(i)
